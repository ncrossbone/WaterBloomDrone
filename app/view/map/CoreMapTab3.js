Ext.define('WaterBloomDrone.view.map.CoreMapTab3', {
	...
	requires: [
		'WaterBloomDrone.view.map.DynamicLayerAdmin3'
	],
	...
	mapRendered: function(p){
        ...
        var timerId = window.setInterval(function(){
        	...
        	me.dynamicLayerAdmin = Ext.create('WaterBloomDrone.view.map.DynamicLayerAdmin3', me.map);
        	me.featureLayerAdmin = Ext.create('WaterBloomDrone.view.map.FeatureLayerAdmin3', me.map);
