Ext.define('WaterBloomDrone.view.map.CoreMapTab2', {
	...
	requires: [
		'WaterBloomDrone.view.map.DynamicLayerAdmin2'
	],
	...
	mapRendered: function(p){
        ...
        var timerId = window.setInterval(function(){
        	...
        	me.dynamicLayerAdmin = Ext.create('WaterBloomDrone.view.map.DynamicLayerAdmin2', me.map);
        	me.featureLayerAdmin = Ext.create('WaterBloomDrone.view.map.FeatureLayerAdmin2', me.map);
        	...
        	WaterBloomDrone.getApplication().coreMap2 = me;
