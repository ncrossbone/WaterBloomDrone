Ext.define('WaterBloomDrone.view.map.CoreMapTab4', {
	...
	requires: [
		'WaterBloomDrone.view.map.DynamicLayerAdmin4'
	],
	...
	mapRendered: function(p){
        ...
        var timerId = window.setInterval(function(){
        	...
        	me.dynamicLayerAdmin = Ext.create('WaterBloomDrone.view.map.DynamicLayerAdmin4', me.map);
        	me.featureLayerAdmin = Ext.create('WaterBloomDrone.view.map.FeatureLayerAdmin4', me.map);
